...
import { Validator } from '../es/validator.js'
...
describe('Model', () => {
  ...
  test('Editor', () => {
    ...
    editor.rollback() // reset to original data which generated by `new`
    ...
    editor2.rollback() // reset to original data which generated by `new`
